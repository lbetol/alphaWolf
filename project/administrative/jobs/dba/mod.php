...
<div id="dbamd" class="ab-window bwindow">
    <div class="ab-restore ttlecolor fntcolor"><icon>&#x24;</icon> <?=$new?"NOVO":"EDITAR"?> DBA <icon>&#x24;</icon> Data de cadastro: <div class="ab-date"></div></div>
    <nav class="ab-controlbox">
            ...
            <icon class="zpd fn fblack cur hrs rt ab-tooltip" data-content="Salvar" onclick="ab_apply(function(){
                ab_loading(true);
                var stts = true;
                $('#dbamd [required]').each(function(){$(this).checkout(function(d){if(!d) stts=false; })});
                   setTimeout(function(){
                    console.log(stts);
                    if(!stts){
    ...
    <div class="stretch ab-rise-dbamd ab-scrollscope">
        ...
        <section class="abs ab-w75% hf ns" style="top:5vh;left:25%;border:1px dotted lightgray">
            <div class="ab-innerscrollable ab-scope">
                ...
                <fieldset class="sbar ab-anchor tct xbs">
                        ...
                        <div class="xts tct">
                            <div><input name="name" type="text" class="required" data-control="dbamd;name"><label>Nome completo</label></div>
                        </div>
                </fieldset>
                ...
                <fieldset class="sbar ab-anchor tct xbs">
                    ...
                    <fieldset class="sbar ab-anchor tct xbs">
                            ...
                            <div class="ab-w80% xts tct">
                                ...
                                <div><input type="tel"   name="tel"   data-control="dbamd;tel">   <label>Telefone</label></div>
                                <div><input type="tel"   name="cel"   data-control="dbamd;cel">   <label>Celular</label> </div><br>
                                <div><input type="email" name="email" data-control="dbamd;email"> <label>Email</label>   </div>
                            </div>
                    </fieldset>
                    <div class="wf hf">.</div>
                </section>   
    ...
    <script>
        ...
        <?php
            if($new){?>
                dbamd.attr('code',ab_newId(32));
                dbamd.attr('date',(new ab_Date()).today());
                dbamd.attr('staff',abox.USER);
        <?php
            }else{?>
                ab_updateControllers("dbamd");
                $("#input").attr("readonly",true);
                <?php
            }
            if((int)post("view")){?>
                $("select, input, textarea","#dbamd").attr("readonly",true);
                <?php
            } ?> 
