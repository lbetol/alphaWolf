...
<html lang="en" >
	...
	<div id = "container">
	  ...
	  .attr("class", "svg");
		...
		{	
			...
			$name = $num["name"];
			$cstg = $num["code"];
			$cron = qout('select * from Schedules where stge="'.$cstg.'"',Types::ARRAY)[0];
	...
	var title = svg.append("text")
	              .text("Cronograma em gráfico de Gantt")
	              .attr("x", w/2)
	              .attr("y", 25)
	...
	rectText.on('mouseover', function(e) {
	 // console.log(this.x.animVal.getItem(this));
	         ...
	         if (d3.select(this).data()[0].details != undefined){
	          tag = "Nome: " + d3.select(this).data()[0].task + "<br/>" + 
	                "Número da fase: " + d3.select(this).data()[0].type + "<br/>" + 
	                "Início: " + d3.select(this).data()[0].startTime + "<br/>" + 
	                "Fim: " + d3.select(this).data()[0].endTime + "<br/>" + 
	                "Descrição: " + d3.select(this).data()[0].details;
	         } else {
	          tag = "Nome: " + d3.select(this).data()[0].task + "<br/>" + 
	                "Número da fase: " + d3.select(this).data()[0].type + "<br/>" + 
	                "Início: " + d3.select(this).data()[0].startTime + "<br/>" + 
	                "Fim: " + d3.select(this).data()[0].endTime;
	         }
